...
<div class="card-body">
 ...
 <tr>
<th>ID</th><th>Titre Formation</th><th>Prix Formation</th><th>Date
Création</th><th>Suppression<th>Edition</th>
 </tr>
 <c:forEach items="${formations}" var="f">
 <tr>
 <td>${f.idFormation }</td>
 <td>${f.titreFormaation }</td>
 <td>${f.prixFormation }</td>
 <td><fmt:formatDate pattern="dd/MM/yyyy"
value="${f.dateAjoutFormation}" /></td>
 <td><a onclick="return confirm('Etes-vous sûr ?')"
href="supprimerFormation?id=${f.idFormation }">Supprimer</a></td>
